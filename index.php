...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  <div class="w3-container">
    ...
    <img src="ava.png" style="width:45%;" class="w3-round"><br><br>
    <h4><b>KubaStroy</b></h4>
    <p class="w3-text-grey">StroyShop</p>
  </div>
...
s="w3-row-padding">
    ...
    <div class="w3-third w3-container">
      <img src="textur4.png" alt="Norway" style="width:100" class="w3-hover-opacity">
      <div class="w3-container w3-white">
        <p><b>Pipes</b></p>
        <p>100$</p>
      </div>
